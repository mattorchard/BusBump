...
public class BidmPrototype {
    ...
    private View createRouteView(Context context, LayoutInflater layoutInflater) {
        ...
        mRouteAdapter = new RouteAdapter(new LinkedList<Route>()) {
            ...
            protected void onItemClick(Route route) {
                BidmPrototype.this.clickRoute(route);
            }
        };
            ...
            public void afterTextChanged(Editable s) {
                if (s.toString().length() == 4) {
                    try {
                        ...
                        BidmPrototype.this.searchForBusStop((stopNo));
    ...
    public BidmPrototype(Context context,
    ...
    private void searchForBusStop(int stopNo) {
        ...
        mTask = new GetRoutesForStop(mRestClient, BidmPrototype.this);
...
class GetRoutesForStop extends GetRoutes {
    ...
    private BidmPrototype mDialogManager;

    GetRoutesForStop(OCTranspoRestClient restClient, BidmPrototype dialogManager) {
        super(restClient);
